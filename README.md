...
- Точка входа: стартовая сцена InitialScene (запускать с неё) и BootstrapInstaller - биндятся основные сервисы здесь. В качестве DI-Container-а выбран Zenject.
...
Подумал как это будет попроще для геймдиза (в рамках ТЗ, конечно) - просто расставить LocationPoints и нажать Collect. Если гейм диз совсем не знаком с юнити можно ещё более удобную и даже автоматическую систему
в реальном проекте.
