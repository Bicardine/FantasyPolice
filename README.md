...
- LogVersion - база любого рабочего проекта для удобства дебагинга и просмотр версии, т.к. иногда тестеры сами не уверены какую версию тестят).
...
С какими-либо трудностями не столкнулся, довольно привычные для меня задачи. В целом было залипательно делать такие механики, нравятся карточные игры. Без проблем вольюсь в другой тип архитектуры и подход в программировании.
