...
Подумал как это будет попроще для геймдиза (в рамках ТЗ и времени, конечно) - просто расставить LocationPoints и нажать Collect. Если гейм диз совсем не знаком с юнити можно ещё более script-kids систему придумать.
